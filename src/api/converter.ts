...
export function fromProject(pbProject: PbProject): Project {
  return {
    ...
    authWebhookMaxRetries: pbProject.authWebhookMaxRetries.toString(),
    ...
    eventWebhookMaxRetries: pbProject.eventWebhookMaxRetries.toString(),
    ...
    snapshotThreshold: pbProject.snapshotThreshold.toString(),
    snapshotInterval: pbProject.snapshotInterval.toString(),
