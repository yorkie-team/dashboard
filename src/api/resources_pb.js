...
proto.api.DocumentSummary.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    key: (f = msg.getKey()) && proto.api.DocumentKey.toObject(includeInstance, f),
 ...
 * @return {!proto.api.DocumentSummary} returns this
 */
proto.api.DocumentSummary.prototype.clearKey = function() {
 ...
 * @return {boolean}
 */
proto.api.DocumentSummary.prototype.hasKey = function() {
  return jspb.Message.getField(this, 2) != null;
};
