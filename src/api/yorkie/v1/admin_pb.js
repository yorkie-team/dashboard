...
proto.yorkie.v1.RemoveDocumentByAdminRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    projectName: jspb.Message.getFieldWithDefault(msg, 1, ""),
    documentKey: jspb.Message.getFieldWithDefault(msg, 2, ""),
    forceRemoveIfAttached: jspb.Message.getBooleanFieldWithDefault(msg, 3, false)
  };
...
proto.yorkie.v1.RemoveDocumentByAdminRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 3:
      var value = /** @type {boolean} */ (reader.readBool());
      msg.setForceRemoveIfAttached(value);
      break;
    default:
      reader.skipField();
      break;
...
proto.yorkie.v1.RemoveDocumentByAdminRequest.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getForceRemoveIfAttached();
  if (f) {
    writer.writeBool(
      3,
      f
...
/**
 * optional bool force_remove_if_attached = 3;
 * @return {boolean}
 */
proto.yorkie.v1.RemoveDocumentByAdminRequest.prototype.getForceRemoveIfAttached = function() {
 ...
 * @return {!proto.yorkie.v1.RemoveDocumentByAdminRequest} returns this
 */
proto.yorkie.v1.RemoveDocumentByAdminRequest.prototype.setForceRemoveIfAttached = function(value) {
