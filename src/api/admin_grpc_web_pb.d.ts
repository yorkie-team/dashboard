...
export class AdminClient {
  ...
  createProject(
    ...
    callback: (
      ...
      response: admin_pb.CreateProjectResponse,
    ) => void,
  ...
  listProjects(
    ...
    callback: (
      err: grpcWeb.RpcError,
      response: admin_pb.ListProjectsResponse,
    ) => void,
  ...
  updateProject(
    ...
    callback: (
      err: grpcWeb.RpcError,
      response: admin_pb.UpdateProjectResponse,
    ) => void,
  ...
  listDocuments(
    ...
    callback: (
      err: grpcWeb.RpcError,
      response: admin_pb.ListDocumentsResponse,
    ) => void,
  ...
  getDocument(
    ...
    callback: (
      err: grpcWeb.RpcError,
      response: admin_pb.GetDocumentResponse,
    ) => void,
